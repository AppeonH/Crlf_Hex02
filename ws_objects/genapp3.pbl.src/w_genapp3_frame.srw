HA$PBExportHeader$w_genapp3_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_genapp3_frame from window
end type
type mdi_1 from mdiclient within w_genapp3_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_genapp3_frame"
...
global w_genapp3_frame w_genapp3_frame

type variables
n_genapp3_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_genapp3_basesheet aw_sheet)
public function long of_classcount (readonly w_genapp3_basesheet aw_sheet)
public function integer of_adjustmenu (ref m_genapp3_frame am_menu)
end prototypes
...
string ls_sheets[]  = { "w_genapp3_sheet1", "w_genapp3_sheet2", "w_genapp3_sheet3" }
...
inv_sheetmgt = Create n_genapp3_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_genapp3_frame.create
if this.MenuName = "m_genapp3_frame" then this.MenuID = create m_genapp3_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_genapp3_frame.destroy
