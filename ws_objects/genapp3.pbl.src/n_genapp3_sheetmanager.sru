HA$PBExportHeader$n_genapp3_sheetmanager.sru
$PBExportComments$Generated MDI Sheet Management
forward
global type n_genapp3_sheetmanager from nonvisualobject
end type
end forward

global type n_genapp3_sheetmanager from nonvisualobject
end type
global n_genapp3_sheetmanager n_genapp3_sheetmanager

type variables
string is_sheets[], is_display[]
w_genapp3_basesheet iw_opensheets[]
menu im_items[]
end variables
...
public function long of_sheetisclosing (readonly w_genapp3_basesheet aw_sheet)
...
li_rc = OpenSheet ( lw_sheet, as_sheetname, w_genapp3_frame, 0, Cascaded! ) 
...
w_genapp3_basesheet lw_sheets[], lw_init[]
...
lm_menu = w_genapp3_frame.MenuId
...
w_genapp3_sheet1	lw_sheet1
w_genapp3_sheet2	lw_sheet2
w_genapp3_sheet3	lw_sheet3
...
on n_genapp3_sheetmanager.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_genapp3_sheetmanager.destroy
