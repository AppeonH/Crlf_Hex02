HA$PBExportHeader$n_genapp3_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_genapp3_connectservice from nonvisualobject
end type
end forward

global type n_genapp3_connectservice from nonvisualobject
end type
global n_genapp3_connectservice n_genapp3_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		string ls_inifile = "D:\temp\2020-07-27\Git\bug92_hex002\genapp3.ini"
...
on n_genapp3_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_genapp3_connectservice.destroy
