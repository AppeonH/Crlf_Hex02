HA$PBExportHeader$n_genapp4_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_genapp4_connectservice from nonvisualobject
end type
end forward

global type n_genapp4_connectservice from nonvisualobject
end type
global n_genapp4_connectservice n_genapp4_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		string ls_inifile = "D:\temp\2020-07-27\Git\bug92_hex002\genapp4.ini"
...
on n_genapp4_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_genapp4_connectservice.destroy
