HA$PBExportHeader$w_genapp4_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_genapp4_frame from window
end type
type mdi_1 from mdiclient within w_genapp4_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_genapp4_frame"
...
global w_genapp4_frame w_genapp4_frame

type variables
n_genapp4_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_genapp4_basesheet aw_sheet)
...
string ls_sheets[]  = { "w_genapp4_sheet1", "w_genapp4_sheet2", "w_genapp4_sheet3" }
...
inv_sheetmgt = Create n_genapp4_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_genapp4_frame.create
if this.MenuName = "m_genapp4_frame" then this.MenuID = create m_genapp4_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_genapp4_frame.destroy
