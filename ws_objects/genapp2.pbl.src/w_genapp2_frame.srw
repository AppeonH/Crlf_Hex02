HA$PBExportHeader$w_genapp2_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_genapp2_frame from window
end type
type mdi_1 from mdiclient within w_genapp2_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_genapp2_frame"
...
global w_genapp2_frame w_genapp2_frame

type variables
n_genapp2_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_genapp2_basesheet aw_sheet)
...
string ls_sheets[]  = { "w_genapp2_sheet1", "w_genapp2_sheet2", "w_genapp2_sheet3" }
...
inv_sheetmgt = Create n_genapp2_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_genapp2_frame.create
if this.MenuName = "m_genapp2_frame" then this.MenuID = create m_genapp2_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_genapp2_frame.destroy
